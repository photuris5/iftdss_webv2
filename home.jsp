                        ...
                        <div class="container" style="margin:0 auto">
                            <div class="col-lg-8 col-md-8"> <!-- style="text-align:center;"> -->
                                <div style="margin: 0 auto;max-width:700px;">
                                    ...
                                    <h4 style="color:#800000;margin-bottom:0;">Please excuse any bugs and quirks as we upgrade IFTDSS. Report any new defects or bugs to our <a href="mailto:IFTDSS.help@firenet.gov?subject=IFTDSS%20Feedback">FEEDBACK email.</a></h4>
